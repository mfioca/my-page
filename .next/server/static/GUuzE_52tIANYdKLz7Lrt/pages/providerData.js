...
function (_Component) {
  ...
  Object(createClass["a" /* default */])(ProviderList, [{
    ...
    value: function parseData(data) {
      ...
      if (data && data.length) {
        if (is_array_default()(sorter) && sorter.length) {
          data.sort(sort["createSorter"].apply(void 0, Object(toConsumableArray["a" /* default */])(sorter)));
        }
      }
    ...
    value: function render() {
      ...
      return this.parseData(providerimport_data) ? this.renderData(providerimport_data) : this.renderLoading();
    }
  }, {
    key: "renderData",
