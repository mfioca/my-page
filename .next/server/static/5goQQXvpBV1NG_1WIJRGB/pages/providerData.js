...
// EXTERNAL MODULE: ./pages/provider_data/provider.json
var provider = __webpack_require__("ErfQ");
...
var providerimport_customFilter = function customFilter(_ref) {
  ...
  return external_react_default.a.createElement("select", {
    ...
    value: ""
  }, "Show All"), provider.map(function (item) {
...
function (_Component) {
  ...
  Object(createClass["a" /* default */])(ProviderList, [{
    key: "render",
    value: function render() {
      return provider ? this.renderData(provider) : this.renderLoading();
    }
  }, {
    key: "renderData",
...
var providerData_data = __webpack_require__("ErfQ"); // {data.filter(data => data.Type === 'Provider').length}: 
...
var providerData_Providerinfo =
/*#__PURE__*/
function (_React$Component) {
  Object(inherits["a" /* default */])(Providerinfo, _React$Component);

  function Providerinfo() {
    Object(classCallCheck["a" /* default */])(this, Providerinfo);

    return Object(possibleConstructorReturn["a" /* default */])(this, Object(getPrototypeOf["a" /* default */])(Providerinfo).apply(this, arguments));
  }

  Object(createClass["a" /* default */])(Providerinfo, [{
    key: "render",
    value: function render() {
      return external_react_default.a.createElement("div", {
      ...
      }, external_react_default.a.createElement("b", null, external_react_default.a.createElement("u", null, "Provider Totals"))), external_react_default.a.createElement("table", {
        className: "Provider-info-table"
      }, external_react_default.a.createElement("tbody", null, external_react_default.a.createElement("tr", null, external_react_default.a.createElement("th", {
        className: "left"
      }, "Total Transportation Providers:"), external_react_default.a.createElement("td", null, providerData_data.length)), external_react_default.a.createElement("tr", null, external_react_default.a.createElement("td", {
        className: "right"
      }, "Transportation Companies:"), external_react_default.a.createElement("td", null, providerData_data.filter(function (data) {
        return data.Type === 'Provider';
      }).length)), external_react_default.a.createElement("tr", null, external_react_default.a.createElement("td", {
        className: "right"
      }, "Volunteer Drivers:"), external_react_default.a.createElement("td", null, providerData_data.filter(function (data) {
        return data.Type === 'Volunteer Driver';
      }).length)), external_react_default.a.createElement("tr", null, external_react_default.a.createElement("th", {
        className: "left"
      }, "Central Region Providers:"), external_react_default.a.createElement("td", null, providerData_data.filter(function (data) {
        ...
        className: "left"
      }, "SouthWest Region:"), external_react_default.a.createElement("td", null, providerData_data.filter(function (data) {
        ...
        className: "left"
      }, "East Region:"), external_react_default.a.createElement("td", null, providerData_data.filter(function (data) {
      ...
      }).length))))), external_react_default.a.createElement("div", null, external_react_default.a.createElement("p", {
        className: "center Fsize-2"
      }, external_react_default.a.createElement("b", null, external_react_default.a.createElement("u", null, "Level of Service Totals"))), external_react_default.a.createElement("table", {
        className: "Provider-info-table"
      }, external_react_default.a.createElement("tbody", null, external_react_default.a.createElement("tr", null, external_react_default.a.createElement("th", {
        className: "left"
      }, "All Regions:")), external_react_default.a.createElement("tr", null, external_react_default.a.createElement("td", {
        className: "right"
      }, "Providers with Ambulatory:"), external_react_default.a.createElement("td", null, providerData_data.filter(function (data) {
        return data.Amb === 'Yes';
      }).length)), external_react_default.a.createElement("tr", null, external_react_default.a.createElement("td", {
        className: "right"
      }, "Providers with Wheelchair:"), external_react_default.a.createElement("td", null, providerData_data.filter(function (data) {
        return data.WCHR === 'Yes';
      }).length)), external_react_default.a.createElement("tr", null, external_react_default.a.createElement("td", {
        className: "right"
      }, "Providers with Stretcher:"), external_react_default.a.createElement("td", null, providerData_data.filter(function (data) {
        return data.Stretcher === 'Yes';
      }).length)), external_react_default.a.createElement("tr", null, external_react_default.a.createElement("th", {
        className: "left"
      }, "Central:")), external_react_default.a.createElement("tr", null, external_react_default.a.createElement("td", {
        className: "right"
      }, "Providers with Ambulatory:"), external_react_default.a.createElement("td", null, providerData_data.filter(function (data) {
        ...
        className: "left"
      }, "SouthWest:")), external_react_default.a.createElement("tr", null, external_react_default.a.createElement("td", {
        className: "right"
      }, "Providers with Ambulatory:"), external_react_default.a.createElement("td", null, providerData_data.filter(function (data) {
        ...
        className: "left"
      }, "East:")), external_react_default.a.createElement("tr", null, external_react_default.a.createElement("td", {
        className: "right"
      }, "Providers with Ambulatory:"), external_react_default.a.createElement("td", null, providerData_data.filter(function (data) {
