...
module.exports = __webpack_require__("6j9H");
...
// CONCATENATED MODULE: ./pages/test_items/Filter.js
...
// CONCATENATED MODULE: ./pages/test_items/jsonsearch.js
...
var jsonsearch_data = __webpack_require__("Jwbl");
...
function (_Component) {
  ...
  Object(createClass["a" /* default */])(List, [{
    ...
    value: function render() {
      return jsonsearch_data ? this.renderData(jsonsearch_data) : this.renderLoading();
    }
  }, {
    key: "renderData",
    value: function renderData(data) {
      ...
      if (data && data.length > 0) {
        if (is_array_default()(filters) && filters.length) {
          data = data.filter(createFilter.apply(void 0, Object(toConsumableArray["a" /* default */])(filters)));
        }
...
Object(defineProperty["a" /* default */])(jsonsearch_List, "defaultProps", {
  filters: [{
    property: 'Name',
    value: ''
  }, {
...
/* harmony default export */ var jsonsearch = __webpack_exports__["default"] = (jsonsearch_List);
/* render () {
